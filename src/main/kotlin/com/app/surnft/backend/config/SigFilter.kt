...
import com.app.surnft.backend.config.properties.WebSecurityProperties
...
class SigFilter(
  ...
  override fun doFilterInternal(
    ...
    val cachedRequest = com.app.surnft.backend.config.CopyingRequestWrapper(request)
  ...
  private fun buildSignedPayload(cachedRequest: com.app.surnft.backend.config.CopyingRequestWrapper): String = buildString {
