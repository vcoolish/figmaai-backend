...
object ImageSpecification {
  ...
  fun userEqual(figma: String?): Specification<ImageAI> = Specification { root, _, builder ->
    if (figma == null) {
    ...
    return@Specification builder.equal(userJoin.get(User::figma), figma.lowercase())
  }
